...
namespace cntrl.Class
{
    public class UpdateMovementReApprove
    {
        ...
        public void ValueChange(db db, int ID, entity.App.Names Application)
        {
            ...
            foreach (sales_invoice_detail sales_invoice_detail in OriginalSalesInvoice.sales_invoice_detail)
            {
                sales_invoice_detail Oldsales_invoice_detail = Local_SalesInvoice.sales_invoice_detail.Where(x => x == sales_invoice_detail).FirstOrDefault();
