namespace entity
{
    ...
    public partial class app_account_detail_archive : Audit, IDataErrorInfo
    {
        

        public app_account_detail_archive()
        {
        ...
        public app_account_detail.tran_types? tran_type { get; set; }
