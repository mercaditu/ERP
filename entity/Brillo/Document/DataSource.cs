            ...
            using (db db = new db())
            {
                ...
                reportDataSource.Value = sales_budget_detail
                    .Select(g => new
                    {
                        ...
                        currency = g.sales_budget.app_currencyfx.app_currency.name,
        ...
        public ReportDataSource SalesInvoice(sales_invoice sales_invoice)
        {
            using (db db = new db())
            {
                ...
                reportDataSource.Value = sales_invoice_detail.Select(g => new
                {
                    ...
                    currency = g.sales_invoice.app_currencyfx.app_currency.name,
                    currencyfx_rate = g.sales_invoice.app_currencyfx.sell_value,
                    quantity = g.quantity,
                    sub_Total = g.SubTotal,
                    sub_Total_vat = g.SubTotal_Vat,
                    unit_cost = g.unit_cost,
