...
namespace entity.Brillo.Promotion
{
    public class Start
    {
        ...
        public void Calculate_SalesInvoice(ref sales_invoice SalesInvoice)
        {
            ...
            /// Set discounts to Zero, so that you can run the promotion over again as if it were the first time.
            /// This prevents duplicate discounts from being inserted.
            foreach (sales_invoice_detail detail in SalesInvoice.sales_invoice_detail)
            { detail.discount = 0; }

            ///Run through the entire list of promotions. Any new promotions should be called here.
        ...
        /// <summary>
        /// BuyThis GetThat is a promotion where you get a free product upon buying something.
        /// </summary>
            ...
            if (Promo.type == sales_promotion.salesPromotion.BuyTag_GetThat)
            {
                ...
                if (DetailTagList.Count() > 0 && TotalQuantity >= Promo.quantity_step)
                {
                    foreach (DetailTag _DetailTag in DetailTagList)
                    {
                        ...
                        {
                            Title = Localize.StringText("SalesPromotion"),
        ...
        /// <summary>
        /// Direct Discount on an Item in Percentage
        /// </summary>
        /// <param name="Promo"></param>
        /// <param name="SalesInvoice"></param>
        ...
        /// <summary>
        /// Direct Discount on an Item because of the Tag it has.
        /// </summary>
        /// <param name="Promo"></param>
        /// <param name="SalesInvoice"></param>
        ...
        /// <summary>
        /// Direct discount based on how much customer is buying.
        /// </summary>
        /// <param name="Promo"></param>
        /// <param name="SalesInvoice"></param>
        ...
        /// <summary>
        /// Discount by Customer Type. Customer Tag.
        /// </summary>
        /// <param name="Promo"></param>
        /// <param name="SalesInvoice"></param>
