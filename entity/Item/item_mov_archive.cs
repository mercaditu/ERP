namespace entity
{
    ...
    public partial class item_mov_archive : Audit
    {
        public enum Actions
        {
            ReApprove,
        ...
        public item_mov_archive()
        {
            ...
            debit = 0;
            credit = 0;
            child = new List<item_mov_archive>();
        }
        ...
        public virtual ICollection<item_mov_archive> child { get; set; }

        public virtual item_mov_archive parent { get; set; }
        ...
        public void Update_ChildVales(decimal BaseValue, bool SkipCurrentItemUpdate,DateTime EntryDate)
        {
            ...
            foreach (item_mov_archive this_child in child)
            {
        ...
        {
            foreach (item_mov_archive item_movement in child)
            {
