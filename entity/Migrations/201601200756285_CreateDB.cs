    ...
    public partial class CreateDB : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        debit = c.Decimal(nullable: false, precision: 20, scale: 4),
                        credit = c.Decimal(nullable: false, precision: 20, scale: 4),
                ...
                c => new
                    {
                        ...
                        name = c.String(nullable: false, unicode: false),
                        code = c.String(nullable: false, unicode: false),
                        geo_lat = c.Decimal(precision: 20, scale: 4),
                        geo_long = c.Decimal(precision: 20, scale: 4),
                ...
                c => new
                    {
                        ...
                        name = c.String(nullable: false, unicode: false),
                        code = c.String(unicode: false),
                        initial_amount = c.Decimal(precision: 20, scale: 4),
                        is_active = c.Boolean(nullable: false),
                        id_company = c.Int(nullable: false),
                        id_user = c.Int(nullable: false),
                        is_head = c.Boolean(nullable: false),
                ...
                c => new
                    {
                        ...
                        buy_value = c.Decimal(nullable: false, precision: 20, scale: 4),
                        sell_value = c.Decimal(nullable: false, precision: 20, scale: 4),
                        is_active = c.Boolean(nullable: false),
                        id_company = c.Int(nullable: false),
                        id_user = c.Int(nullable: false),
                        is_head = c.Boolean(nullable: false),
                ...
                c => new
                    {
                        ...
                        max_value = c.Decimal(nullable: false, precision: 20, scale: 4),
                ...
                c => new
                    {
                        ...
                        unit_cost = c.Decimal(precision: 20, scale: 4),
                        link_code = c.Int(),
                        is_autorecepie = c.Boolean(nullable: false),
                        has_promo = c.Boolean(nullable: false),
                        is_active = c.Boolean(nullable: false),
                        is_substitute = c.Boolean(nullable: false),
                        id_company = c.Int(nullable: false),
                        id_user = c.Int(nullable: false),
                        is_head = c.Boolean(nullable: false),
                        timestamp = c.DateTime(nullable: false, precision: 0),
                ...
                c => new
                    {
                        ...
                        id_item = c.Int(nullable: false),
                        stock_min = c.Decimal(precision: 20, scale: 4),
                        stock_max = c.Decimal(precision: 20, scale: 4),
                ...
                c => new
                    {
                        ...
                        name = c.String(nullable: false, unicode: false),
                        coefficient = c.Decimal(nullable: false, precision: 20, scale: 4),
                ...
                c => new
                    {
                        ...
                        purchase_value = c.Decimal(precision: 20, scale: 4),
                        current_value = c.Decimal(precision: 20, scale: 4),
                        speed = c.Decimal(precision: 20, scale: 4),
                        dieset_price = c.Decimal(precision: 20, scale: 4),
                        min_length = c.Decimal(precision: 20, scale: 4),
                        max_length = c.Decimal(precision: 20, scale: 4),
                        min_width = c.Decimal(precision: 20, scale: 4),
                        max_width = c.Decimal(precision: 20, scale: 4),
                        id_company = c.Int(nullable: false),
                        id_user = c.Int(nullable: false),
                        is_head = c.Boolean(nullable: false),
                        timestamp = c.DateTime(nullable: false, precision: 0),
                ...
                c => new
                    {
                        ...
                        name = c.String(unicode: false),
                        depreciation_rate = c.Decimal(precision: 20, scale: 4),
                ...
                c => new
                    {
                        ...
                        credit_limit = c.Decimal(precision: 20, scale: 4),
                        lead_time = c.Int(),
                        geo_lat = c.Decimal(precision: 20, scale: 4),
                        geo_long = c.Decimal(precision: 20, scale: 4),
                ...
                c => new
                    {
                        ...
                        id_contact = c.Int(nullable: false),
                        id_item = c.String(unicode: false),
                        id_contract = c.Int(nullable: false),
                        start_date = c.DateTime(nullable: false, precision: 0),
                        end_date = c.DateTime(precision: 0),
                        bill_cycle = c.Short(nullable: false),
                ...
                c => new
                    {
                        ...
                        id_department = c.Int(),
                        id_currency = c.Int(),
                        base_salary = c.Decimal(nullable: false, precision: 20, scale: 4),
                ...
                c => new
                    {
                        ...
                        end_date = c.DateTime(precision: 0),
                        average = c.Decimal(precision: 20, scale: 4),
                        comment = c.String(unicode: false),
                        id_company = c.Int(nullable: false),
                        id_user = c.Int(nullable: false),
                        is_head = c.Boolean(nullable: false),
                ...
                c => new
                    {
                        ...
                        id_contact = c.Int(nullable: false),
                        experience = c.Decimal(nullable: false, precision: 20, scale: 4),
                        id_company = c.Int(nullable: false),
                        id_user = c.Int(nullable: false),
                        is_head = c.Boolean(nullable: false),
                        timestamp = c.DateTime(nullable: false, precision: 0),
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        id_production_execution = c.Int(nullable: false),
                        id_order_detail = c.Int(),
                        id_project_task = c.Int(),
                ...
                .ForeignKey("production_execution", t => t.id_production_execution, cascadeDelete: true)
                .ForeignKey("production_order_detail", t => t.id_order_detail)
                .ForeignKey("project_task", t => t.id_project_task)
                .ForeignKey("security_user", t => t.id_user, cascadeDelete: true)
                .Index(t => t.id_production_execution)
                .Index(t => t.id_order_detail)
                .Index(t => t.id_project_task)
            ...
            CreateTable(
                ...
                c => new
                    {
                        id_production_execution = c.Int(nullable: false, identity: true),
                ...
                .PrimaryKey(t => t.id_production_execution)                
                .ForeignKey("app_company", t => t.id_company, cascadeDelete: true)
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        is_head = c.Boolean(nullable: false),
                        timestamp = c.DateTime(nullable: false, precision: 0),
                        _parent_id_movement = c.Long(),
                    })
                .PrimaryKey(t => t.id_movement)                
                .ForeignKey("item_movement", t => t._parent_id_movement)
                .ForeignKey("app_company", t => t.id_company, cascadeDelete: true)
                .ForeignKey("app_location", t => t.id_location, cascadeDelete: true)
                .ForeignKey("item_product", t => t.id_item_product, cascadeDelete: true)
                .ForeignKey("security_user", t => t.id_user, cascadeDelete: true)
                ...
                .Index(t => t.id_company)
                .Index(t => t.id_user)
                .Index(t => t._parent_id_movement);
            
            CreateTable(
                "item_movement_dimension",
                c => new
                    {
                        id_movement_property = c.Long(nullable: false, identity: true),
                ...
                .PrimaryKey(t => t.id_movement_property)                
                .ForeignKey("app_company", t => t.id_company, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        name = c.String(nullable: false, unicode: false),
                        code = c.String(unicode: false),
                        quantity_est = c.Decimal(precision: 20, scale: 4),
                        unit_cost_est = c.Decimal(precision: 20, scale: 4),
                        start_date_est = c.DateTime(precision: 0),
                        end_date_est = c.DateTime(precision: 0),
                ...
                c => new
                    {
                        ...
                        id_vat_group = c.Int(nullable: false),
                        unit_cost = c.Decimal(nullable: false, precision: 20, scale: 4),
                        discount = c.Decimal(nullable: false, precision: 20, scale: 4),
                        comment = c.String(unicode: false),
                        id_company = c.Int(nullable: false),
                        id_user = c.Int(nullable: false),
                        is_head = c.Boolean(nullable: false),
                ...
                c => new
                    {
                        ...
                        range_start = c.Short(nullable: false),
                        range_current = c.Short(nullable: false),
                        range_end = c.Short(nullable: false),
                ...
                c => new
                    {
                        ...
                        id_branch = c.Int(nullable: false),
                        temp = c.Decimal(precision: 20, scale: 4),
                        temp_min = c.Decimal(precision: 20, scale: 4),
                        temp_max = c.Decimal(precision: 20, scale: 4),
                        pressure = c.Decimal(precision: 20, scale: 4),
                        humidity = c.Decimal(precision: 20, scale: 4),
                        wind_speed = c.Decimal(precision: 20, scale: 4),
                        wind_type = c.Decimal(precision: 20, scale: 4),
                        wind_direction = c.Decimal(precision: 20, scale: 4),
                        timestamp = c.DateTime(nullable: false, precision: 0),
                    })
            ...
            CreateTable(
                ...
                .ForeignKey("app_company", t => t.id_company, cascadeDelete: true)
                .ForeignKey("app_currencyfx", t => t.id_currencyfx, cascadeDelete: true)
                .ForeignKey("payments", t => t.id_payment, cascadeDelete: true)
                .ForeignKey("payment_type", t => t.id_payment_type, cascadeDelete: true)
                .ForeignKey("security_user", t => t.id_user, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        id_contact = c.Int(),
                        status = c.Int(nullable: false),
                        payment_number = c.String(unicode: false),
                        trans_date = c.DateTime(nullable: false, precision: 0),
                        id_company = c.Int(nullable: false),
                        id_user = c.Int(nullable: false),
                        is_head = c.Boolean(nullable: false),
                ...
                c => new
                    {
                        ...
                        id_currencyfx = c.Int(nullable: false),
                        value = c.Decimal(nullable: false, precision: 20, scale: 4),
                        interest = c.Decimal(nullable: false, precision: 20, scale: 4),
                        trans_date = c.DateTime(nullable: false, precision: 0),
                ...
                c => new
                    {
                        ...
                        name = c.String(nullable: false, unicode: false),
                        code = c.String(unicode: false),
                        commision_base = c.Decimal(precision: 20, scale: 4),
                ...
                c => new
                    {
                        ...
                        quantity = c.Decimal(nullable: false, precision: 20, scale: 4),
                        id_vat_group = c.Int(nullable: false),
                        unit_price = c.Decimal(nullable: false, precision: 20, scale: 4),
                        unit_cost = c.Decimal(nullable: false, precision: 20, scale: 4),
                        discount = c.Decimal(nullable: false, precision: 20, scale: 4),
                        comment = c.String(unicode: false),
                        id_company = c.Int(nullable: false),
                ...
                c => new
                    {
                        ...
                        id_range = c.Int(),
                        packing_number = c.String(unicode: false),
                        comment = c.String(unicode: false),
                        trans_date = c.DateTime(nullable: false, precision: 0),
                        status = c.Int(nullable: false),
                        is_issued = c.Boolean(nullable: false),
            ...
            CreateTable(
                ...
                c => new
                    {
                        id_sales_invoice_detail = c.Long(nullable: false, identity: true),
                        id_sales_invoice = c.Int(nullable: false),
                        id_sales_order_detail = c.Int(),
                        id_location = c.Int(),
                        id_project_task = c.Int(),
                ...
                c => new
                    {
                        ...
                        id_currency = c.Int(nullable: false),
                        value = c.Decimal(nullable: false, precision: 20, scale: 4),
                        min_quantity = c.Decimal(nullable: false, precision: 20, scale: 4),
                        id_company = c.Int(nullable: false),
                        id_user = c.Int(nullable: false),
                        is_head = c.Boolean(nullable: false),
                        timestamp = c.DateTime(nullable: false, precision: 0),
                ...
                c => new
                    {
                        ...
                        is_head = c.Boolean(nullable: false),
                        timestamp = c.DateTime(nullable: false, precision: 0),
                        item_detail_id_item = c.Int(),
                        item_head_id_item = c.Int(),
                        item_id_item = c.Int(),
                    })
                .PrimaryKey(t => t.id_recepie)                
                .ForeignKey("app_company", t => t.id_company, cascadeDelete: true)
                .ForeignKey("items", t => t.item_detail_id_item)
                .ForeignKey("items", t => t.item_head_id_item)
                .ForeignKey("security_user", t => t.id_user, cascadeDelete: true)
                .ForeignKey("items", t => t.item_id_item)
                .Index(t => t.id_company)
                .Index(t => t.id_user)
                .Index(t => t.item_detail_id_item)
                .Index(t => t.item_head_id_item)
            ...
            CreateTable(
                ...
                c => new
                    {
                        id_curd = c.Int(nullable: false, identity: true),
                        id_role = c.Int(nullable: false),
                        id_application = c.Int(nullable: false),
                ...
                c => new
                    {
                        ...
                        value_max = c.Decimal(precision: 20, scale: 4),
                    })
                ...
                c => new
                    {
                        ...
                        id_item_product = c.Int(nullable: false),
                        status = c.Int(nullable: false),
                        value_system = c.Decimal(nullable: false, precision: 20, scale: 4),
                        value_counted = c.Decimal(nullable: false, precision: 20, scale: 4),
                        comment = c.String(unicode: false),
                        id_company = c.Int(nullable: false),
                        id_user = c.Int(nullable: false),
                        is_head = c.Boolean(nullable: false),
                ...
                c => new
                    {
                        ...
                        id_item_product = c.Int(nullable: false),
                        quantity_origin = c.Decimal(nullable: false, precision: 20, scale: 4),
                        quantity_destination = c.Decimal(nullable: false, precision: 20, scale: 4),
                        id_company = c.Int(nullable: false),
                        id_user = c.Int(nullable: false),
                        is_head = c.Boolean(nullable: false),
                        timestamp = c.DateTime(nullable: false, precision: 0),
            ...
            CreateTable(
                ...
                .ForeignKey("app_company", t => t.id_company, cascadeDelete: true)
                .ForeignKey("app_currencyfx", t => t.id_currencyfx, cascadeDelete: true)
                .ForeignKey("app_document_range", t => t.id_range, cascadeDelete: true)
                .ForeignKey("contacts", t => t.id_contact, cascadeDelete: true)
                .ForeignKey("security_user", t => t.id_user, cascadeDelete: true)
                .Index(t => t.id_contact)
                .Index(t => t.id_range)
                ...
                c => new
                    {
                        ...
                        id_tag = c.Int(nullable: false),
                        id_item = c.Int(nullable: false),
                        consumption = c.Decimal(nullable: false, precision: 20, scale: 4),
                ...
                c => new
                    {
                        ...
                        id_project_event_template = c.Int(nullable: false),
                        id_tag = c.Int(nullable: false),
                        adult_consumption = c.Decimal(nullable: false, precision: 20, scale: 4),
                        child_consumption = c.Decimal(nullable: false, precision: 20, scale: 4),
                        is_active = c.Boolean(nullable: false),
                        id_company = c.Int(nullable: false),
                        id_user = c.Int(nullable: false),
                        is_head = c.Boolean(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("security_curd", "id_role", "security_role");
            ...
            DropForeignKey("production_execution", "id_user", "security_user");
            DropForeignKey("production_execution", "id_production_order", "production_order");
            ...
            DropForeignKey("production_execution", "id_production_line", "production_line");
            ...
            DropForeignKey("item_movement", "_parent_id_movement", "item_movement");
            ...
            DropForeignKey("production_execution_detail", "id_production_execution", "production_execution");
            DropForeignKey("production_execution", "id_company", "app_company");
            ...
            DropIndex("security_curd", new[] { "id_role" });
            ...
            DropIndex("item_movement", new[] { "_parent_id_movement" });
            ...
            DropIndex("production_execution", new[] { "id_user" });
            DropIndex("production_execution", new[] { "id_company" });
            DropIndex("production_execution", new[] { "id_production_order" });
            DropIndex("production_execution", new[] { "id_production_line" });
            ...
            DropIndex("production_execution_detail", new[] { "id_production_execution" });
            ...
            DropTable("production_execution");
