    ...
    public partial class INITIALMIGRATE : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        comment = c.String(unicode: false),
                        work_type = c.Int(nullable: false),
                        is_active = c.Boolean(nullable: false),
                        id_company = c.Int(nullable: false),
                        id_user = c.Int(nullable: false),
                        is_head = c.Boolean(nullable: false),
            ...
            CreateTable(
                ...
                c => new
                    {
                        id_production_account = c.Int(nullable: false, identity: true),
                        id_contact = c.Int(nullable: false),
                        id_item = c.Int(nullable: false),
                        id_order_detail = c.Int(),
                        id_execution_detail = c.Int(),
                        ...
                        timestamp = c.DateTime(nullable: false, precision: 0),
                        is_read = c.Boolean(nullable: false),
                        parent_id_production_account = c.Int(),
                    })
                .PrimaryKey(t => t.id_production_account)                
                .ForeignKey("app_company", t => t.id_company, cascadeDelete: true)
                .ForeignKey("production_account", t => t.parent_id_production_account)
                .ForeignKey("contacts", t => t.id_contact, cascadeDelete: true)
                .ForeignKey("items", t => t.id_item, cascadeDelete: true)
                .ForeignKey("production_execution_detail", t => t.id_execution_detail)
                .ForeignKey("production_order_detail", t => t.id_order_detail)
                ...
                .Index(t => t.id_company)
                .Index(t => t.id_user)
                .Index(t => t.parent_id_production_account);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("item_inventory_dimension", "id_measurement", "app_measurement");
            ...
            DropForeignKey("production_account", "id_user", "security_user");
            ...
            DropForeignKey("production_account", "id_purchase_order_detail", "purchase_order_detail");
            ...
            DropForeignKey("production_account", "id_purchase_invoice_detail", "purchase_invoice_detail");
            ...
            DropForeignKey("item_movement_dimension", "id_measurement", "app_measurement");
            ...
            DropForeignKey("production_account", "id_order_detail", "production_order_detail");
            ...
            DropForeignKey("production_account", "id_item", "items");
            DropForeignKey("production_account", "id_contact", "contacts");
            DropForeignKey("production_account", "parent_id_production_account", "production_account");
            DropForeignKey("production_account", "id_company", "app_company");
            ...
            DropIndex("item_inventory_dimension", new[] { "id_measurement" });
            ...
            DropIndex("item_movement_dimension", new[] { "id_measurement" });
            ...
            DropIndex("production_account", new[] { "parent_id_production_account" });
            DropIndex("production_account", new[] { "id_user" });
            DropIndex("production_account", new[] { "id_company" });
            DropIndex("production_account", new[] { "id_purchase_invoice_detail" });
            DropIndex("production_account", new[] { "id_purchase_order_detail" });
            DropIndex("production_account", new[] { "id_execution_detail" });
            DropIndex("production_account", new[] { "id_order_detail" });
            DropIndex("production_account", new[] { "id_item" });
            DropIndex("production_account", new[] { "id_contact" });
