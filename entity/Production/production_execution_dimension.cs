...
namespace entity
{
    public partial class production_execution_dimension : Audit, IDataErrorInfo
    {
        public production_execution_dimension()
        {
        ...
        public int id_execution_dimension { get; set; }
